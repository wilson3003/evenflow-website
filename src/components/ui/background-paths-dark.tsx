...
export function DarkBackgroundPaths() {
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#141A14]">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-8 max-w-5xl mx-auto">
        ...
        {/* Animated headline */}
        <h1 style={{fontFamily: "var(--font-clash)", fontWeight: 700, letterSpacing: "-0.04em", lineHeight: 0.93, color: "#EFF5EC"}} className="text-[88px] mb-8">
          {["Your emails.", "Your voice.", "Handled."].map((line, lineIndex) => (
        ...
        >
          ...
          <a href="#" style={{fontFamily: "var(--font-dm-mono)", fontSize: "11px", letterSpacing: "0.1em", textTransform: "uppercase", color: "#6A856A", textDecoration: "none"}}>
            See how it works →
          </a>
        </motion.div>
      </div>
