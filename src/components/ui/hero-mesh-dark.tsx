...
export function HeroMeshDark() {
  ...
  // Dark gradient: deep forest, near-black, dark teal, very muted brass
  const colors = ["#070d09", "#0d1a10", "#1a2e20", "#2a3d28", "#c4a35a", "#0a1208"]
  ...
  return (
    <section className="relative w-full min-h-screen overflow-hidden flex items-center justify-center">
      ...
      <nav className="absolute top-0 left-0 right-0 z-20 flex items-center justify-between px-24 h-[72px]">
        ...
        <a href="#" style={{fontFamily:"var(--font-dm-mono)", fontSize:"11px", letterSpacing:"0.1em", textTransform:"uppercase", color:"#0d1a10", background:"#c4a35a", padding:"10px 22px", borderRadius:"4px", textDecoration:"none"}}>
          Book a call
        </a>
      </nav>
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-8 max-w-5xl mx-auto">
        <motion.div
          ...
          style={{background:"rgba(196,163,90,0.12)", border:"1px solid rgba(196,163,90,0.25)"}}
        >
        ...
        <h1 className="mb-8 text-center" style={{lineHeight:1.0}}>
          {["Your emails.", "Your voice."].map((line, i) => (
            <motion.span
              key={i}
              style={{display:"block", fontFamily:"Cormorant Garamond, serif", fontWeight:300, fontSize:"96px", letterSpacing:"-0.02em", color:"#f0e8d0", fontStyle:"italic", lineHeight:1.05}}
        ...
        <motion.p
          ...
          style={{fontFamily:"DM Sans, sans-serif", fontWeight:300, fontSize:"18px", lineHeight:1.75, color:"rgba(240,232,208,0.6)", maxWidth:"500px", marginBottom:"48px"}}
        >
        ...
        >
          <a href="#" style={{fontFamily:"var(--font-dm-mono)", fontSize:"11px", letterSpacing:"0.1em", textTransform:"uppercase", color:"#0d1a10", background:"#c4a35a", padding:"16px 36px", borderRadius:"4px", textDecoration:"none"}}>
            Book your interview
          </a>
          <a href="#" style={{fontFamily:"var(--font-dm-mono)", fontSize:"11px", letterSpacing:"0.1em", textTransform:"uppercase", color:"rgba(240,232,208,0.4)", textDecoration:"none"}}>
            See how it works →
          </a>
        </motion.div>
      </div>
      ...
      <div className="absolute bottom-8 left-0 right-0 flex justify-center z-20">
        <span style={{fontFamily:"Cormorant Garamond, serif", fontStyle:"italic", fontSize:"15px", color:"rgba(240,232,208,0.25)"}}>
          evenflow.agency
        </span>
      </div>
    </section>
